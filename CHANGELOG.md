...
## [0.1.17](https://github.com/KarpelesLab/evmabiless/compare/v0.1.16...v0.1.17) - 2026-09-23

### Other

- add common-signatures feature, WETH deposit/withdraw, MSRV 1.89
- separate the signature table from the decoder
- remove Go Report Card badge (service closed)
